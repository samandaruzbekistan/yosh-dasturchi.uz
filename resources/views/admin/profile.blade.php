                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img src="{{ asset('img/avatars/author.png') }}" alt="author" class="img-fluid rounded-circle mb-2" width="128" height="128">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1">
                                    <i class="align-middle me-1" data-feather="user"></i>F.I.SH: <a href="#">Badalov Azamat</a>
                                </li>
                                <li class="mb-1">
                                    <i class="align-middle me-1" data-feather="briefcase"></i>Ish joyi: <a href="#">GulDU</a></li>
                                <li class="mb-1"><i class="align-middle me-1" data-feather="phone"></i>Telefon: <a href="#">+998 99 472 43 92</a></li>
                            </ul>
                        </div>
                        <hr class="my-0">
                    </div>
